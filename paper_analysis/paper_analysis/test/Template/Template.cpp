...
Template::Template()
{
  ...
  templateParser_ = impl->createLSParser(XERCES_CPP_NAMESPACE::DOMImplementationLS::MODE_SYNCHRONOUS, 0);
  ...
  XERCES_CPP_NAMESPACE::DOMConfiguration *config = templateParser_->getDomConfig();
