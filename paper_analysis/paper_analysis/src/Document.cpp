...
Document::Document()
{
  ...
  parser_ = impl->createLSParser(XERCES_CPP_NAMESPACE::DOMImplementationLS::MODE_SYNCHRONOUS, 0);
  ...
  XERCES_CPP_NAMESPACE::DOMConfiguration *config = parser_->getDomConfig();
...
{
  // 解析 XML 文件并获取文档
  document_ = parser_->parseURI(path.c_str());
