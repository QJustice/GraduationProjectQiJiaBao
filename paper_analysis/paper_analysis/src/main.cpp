...
int main()
{
...
#if 1
  {
    ...
    document.loadDocument("D:\\WorkSpace\\GraduationProject\\word\\Template03\\word\\document.xml");
    ...
    document.setStyle("D:\\WorkSpace\\GraduationProject\\word\\Template03\\word\\styles.xml");
