...
public:
  ...
  // 获取pPr样式
  ErrorCode::ErrorCodeEnum getParagraphStyle(const XERCES_CPP_NAMESPACE::DOMNode* paragraph, XERCES_CPP_NAMESPACE::DOMNode** ppr, XERCES_CPP_NAMESPACE::DOMNode** rpr, XERCES_CPP_NAMESPACE::DOMElement** stylePpr);
  // 检测目标run是否符合模板格式
